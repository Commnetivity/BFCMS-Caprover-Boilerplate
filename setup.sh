...
clear
echo "You can now run your project locally using docker-compose up, make changes and commmit them locally. When you push your commit history, your project will automatically be deployed to caprover as a fresh build, replacing the placeholder page ";
